...
この研究では、自己反省的な記号最適化によってメタメモリを進化させる MetaMem を提案し、長期的な人間と LLM の相互作用における知識活用を可能にします。
</div>
</div>
...
この研究は、ユーザーとアイテムの相互作用履歴から個別化された意味的ショートカットを抽出することで、安定した嗜好の把握を強化し、系列推薦システムを改善します。
</div>
</div>
...
この研究は、エージェントの観点から Retrieval-Augmented Generation を体系的に概観し、知識集約型エージェントを獲得と活用の役割に分類するとともに、マルチエージェント RAG システムにおける共同最適化の今後の方向性を示します。
</div>
</div>
...
この研究は、言語モデルの事前学習能力を導入することで、推薦システムにおけるテキストマッチング性能を大きく向上させました。
</div>
</div>
...
この研究は、多エージェント環境における大規模言語モデルの戦略的行動と意思決定能力を評価するための、ゲーム理論ベースのベンチマーク LLMsPark を提案します。
</div>
</div>
...
この研究は、視覚障害者にまったく新しい映画鑑賞体験をもたらしました。
</div>
</div>
...
この研究は、構造化された認知アウトラインを構築して反復検索を導くことで RAG システムを強化し、多次元知識を一貫したページに整理して、より正確な回答生成を実現します。
</div>
</div>
...
本研究は、対話レベルの感情の推移を捉え、クロスモーダル融合とモダリティ固有情報のバランスを適応的に調整する、コンテキスト認識型ゲート付き Mamba フレームワークを導入することで、マルチモーダル感情分析を改善します。
</div>
</div>
...
この研究では、Wordle を詳細に数値解析し、その背後にある統計的パターンを明らかにしました。
</div>
</div>
