...
該工作透過從使用者互動歷史中學習個人化語義捷徑，更好地建模穩定偏好，從而提升序列推薦系統的效果。
</div>
</div>
...
該工作從智能體視角系統梳理了 Retrieval-Augmented Generation，提出知識密集型智能體的獲取與利用分類框架，並討論了多智能體 RAG 的聯合優化方向。
</div>
</div>
...
該工作透過引入語言模型預訓練能力，顯著提升了推薦系統中文本匹配任務的效能。
</div>
</div>
...
該工作對 Wordle 遊戲進行了細緻的數值分析，並揭示了其中蘊含的統計規律。
</div>
</div>
