...
이 연구는 자기반성적 기호 최적화를 통해 메타 메모리를 진화시키는 MetaMem 프레임워크를 제안하며, 장기적인 인간-LLM 상호작용에서 지식 활용을 가능하게 합니다.
</div>
</div>
...
이 연구는 사용자-아이템 상호작용 이력에서 개인화된 의미적 지름길을 추출하여 안정적인 선호를 더 잘 포착함으로써 순차 추천 시스템을 개선합니다.
</div>
</div>
...
이 연구는 언어 모델 사전학습 능력을 도입하여 추천 시스템의 텍스트 매칭 성능을 크게 향상시켰습니다.
</div>
</div>
...
이 연구는 Wordle 게임을 정밀하게 수치 분석하여 그 안에 숨어 있는 통계적 패턴을 밝혔습니다.
</div>
</div>
