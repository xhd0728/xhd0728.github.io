...
> يشير \* إلى **مساهمة متساوية**، وتشير † إلى **المؤلف المراسل**.
...
يقترح هذا العمل MetaMem، وهو إطار للذاكرة الفوقية يطوّر الذاكرة الفوقية عبر تحسين رمزي قائم على التأمل الذاتي، بما يتيح استخدام المعرفة في التفاعلات طويلة الأمد بين الإنسان والنماذج اللغوية الكبيرة.
</div>
</div>
...
يحسن هذا العمل أنظمة التوصية التسلسلية عبر استخراج اختصارات دلالية شخصية من سجلات تفاعل المستخدمين مع العناصر، مما يعزز التقاط التفضيلات المستقرة للمستخدم.
</div>
</div>
...
يقدم هذا العمل مراجعة شاملة لـ Retrieval-Augmented Generation من منظور قائم على الوكلاء، ويصنّف الوكلاء كثيفي المعرفة إلى أدوار للاكتساب والاستفادة، مع إبراز الاتجاهات المستقبلية للتحسين المشترك في أنظمة RAG متعددة الوكلاء.
</div>
</div>
...
حسّن هذا العمل أداء مطابقة النصوص في أنظمة التوصية بشكل كبير من خلال إدخال قدرات ما قبل التدريب الخاصة بالنماذج اللغوية.
</div>
</div>
...
يقدم هذا العمل LLMsPark، وهي منصة قائمة على نظرية الألعاب لتقييم السلوكيات الاستراتيجية وقدرات اتخاذ القرار لدى النماذج اللغوية الكبيرة في البيئات متعددة الوكلاء، بما يوفر معيارًا جديدًا لتقييم ذكائها.
</div>
</div>
...
فتح هذا العمل تجربة جديدة تمامًا لمشاهدة الأفلام للأشخاص ذوي الإعاقة البصرية.
</div>
</div>
...
يحسّن هذا العمل تحليل المشاعر متعدد الوسائط من خلال تقديم إطار Mamba بآلية بوابات واعية بالسياق، قادر على نمذجة تطور المشاعر على مستوى الحوار والموازنة تكيفيًا بين الدمج عبر الوسائط والمعلومات الخاصة بكل وسيط.
</div>
</div>
...
يعزز هذا العمل أنظمة RAG عبر بناء مخططات معرفية منظمة لتوجيه الاسترجاع التكراري، وتنظيم المعرفة متعددة الأبعاد في صفحات مترابطة لإنتاج إجابات أكثر دقة.
</div>
</div>
...
أجرى هذا العمل تحليلًا عدديًا مفصلًا للعبة Wordle، وكشف عن الأنماط الإحصائية الكامنة فيها.
</div>
</div>
